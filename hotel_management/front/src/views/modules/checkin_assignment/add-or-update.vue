<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="用户�? prop="customerming">
          <el-input v-model="ruleForm.customerming" 
              placeholder="用户�? clearable  :readonly="ro.customerming"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="用户�? prop="customerming">
              <el-input v-model="ruleForm.customerming" 
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="手机�? prop="shoujihao">
          <el-input v-model="ruleForm.shoujihao" 
              placeholder="手机�? clearable  :readonly="ro.shoujihao"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="手机�? prop="shoujihao">
              <el-input v-model="ruleForm.shoujihao" 
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="房间�? prop="fangjianhao">
          <el-input v-model="ruleForm.fangjianhao" 
              placeholder="房间�? clearable  :readonly="ro.fangjianhao"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="房间�? prop="fangjianhao">
              <el-input v-model="ruleForm.fangjianhao" 
...
export default {
  ...
  methods: {
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.kefangtupian = true;
          ...
          if(o=='customerming'){
            this.ruleForm.customerming = obj[o];
	    this.ro.customerming = true;
            continue;
          }
          if(o=='xingming'){
      ...
      this.$http({
        ...
        if (data && data.code === 0) {
          var json = data.data;
		if(json.customerming!=''&&json.customerming){
                this.ruleForm.customerming = json.customerming
	    		this.ro.customerming = true;
		}
    ...
    info(id) {
      this.$http({
        url: `checkin_assignment/info/${id}`,
        method: "get"
      }).then(({ data }) => {
        if (data && data.code === 0) {
		 ...
		 if(crossrefid && crossuserid) {
			...
			this.$http({ 
				...
				if (data && data.code === 0) { 
					 ...
					 this.$http({
					   url: `checkin_assignment/${!this.ruleForm.id ? "save" : "update"}`,
					   method: "post",
					   data: this.ruleForm
					 }).then(({ data }) => {
					   if (data && data.code === 0) {
						 ...
						 this.parent.checkin_assignmentCrossAddOrUpdateFlag = false;
						 this.parent.search();
