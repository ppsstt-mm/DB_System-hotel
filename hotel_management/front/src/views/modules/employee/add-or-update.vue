<template>
  <div class="addEdit-block">
    ...
    >
      <el-row >
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="员工工号" prop="employeegonghao">
          <el-input v-model="ruleForm.employeegonghao" 
              placeholder="员工工号" clearable  :readonly="ro.employeegonghao"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="员工工号" prop="employeegonghao">
              <el-input v-model="ruleForm.employeegonghao" 
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="员工姓名" prop="employeexingming">
          <el-input v-model="ruleForm.employeexingming" 
              placeholder="员工姓名" clearable  :readonly="ro.employeexingming"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="员工姓名" prop="employeexingming">
              <el-input v-model="ruleForm.employeexingming" 
...
export default {
  data() {
    ...
    return {
      ...
      type: '',
      ro:{
	employeegonghao : false,
	employeexingming : false,
	mima : false,
	xingbie : false,
	lianxidianhua : false,
	touxiang : false,
  ...
  methods: {
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
        ...
        for (var o in obj){
          if(o=='employeegonghao'){
            this.ruleForm.employeegonghao = obj[o];
	    this.ro.employeegonghao = true;
            continue;
          }
          if(o=='employeexingming'){
            this.ruleForm.employeexingming = obj[o];
	    this.ro.employeexingming = true;
            continue;
          }
          if(o=='mima'){
